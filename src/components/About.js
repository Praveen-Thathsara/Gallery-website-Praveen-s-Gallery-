...
Thank you for visiting our space, and we look forward to sharing the beauty of nature with you.
 ...
 <div className="row">
  <div className="col-4">
  <button className="linkbtn"><header className="aboutlink"><Link to="/Video">Some of my Videos</Link></header></button><br></br><br></br>
  <div className="aboutlinkpara">
<p>You can see some videos about the nature and places I seen. click above and check it.</p>
</div>
  </div>
  <div className="col-4">
  <button className="linkbtn"><header className="aboutlink"><Link to="/gallery">Picture Gallery</Link></header></button><br></br><br></br>
  <div className="aboutlinkpara">
<p>I invite you to see some of my view. click above and enjoy with nature.</p>

</div>
  </div>
  <div className="col-4">
  <button className="linkbtn"><header className="aboutlink"><Link to="/contact">How to contact me</Link></header></button><br></br><br></br>
  <div className="aboutlinkpara">
<p>If you are a nature lover please put a message to me and you can check more about me through the social media. ckeck it.</p>
</div>
