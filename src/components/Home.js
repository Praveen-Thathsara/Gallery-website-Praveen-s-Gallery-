...
<>
    ...
    <div className="row">
      ...
      <div className="welcome-text2">
        <h1>Hello Mate !</h1>
        <blockquote>"This is the better place to Explore the World. We have the huge photographs and videos collection about nature beauty, Animals, Easthetic vibe. We invite you to Explore the wolrd."  </blockquote>
        <button><Link to="/Contact">Get Sterted</Link></button>
    </div>
      </div>
      <div className="col-6">
